...
speedUp.addEventListener("click", onUpSpeed);
speedDown.addEventListener("click", onDownSpeed);

let speedValue = 10;
let intervalValue = 100;
let speed = `Speed: ${speedValue}`;
console.log(speed);
speedEl.textContent = speed;

function onUpSpeed(evt) {
  intervalValue += 20;
  speedValue += 1;
}

function onDownSpeed(evt) {
  intervalValue -= 20;
  speedValue -= 1;
}
